...
function addDataToLibraries(files, dataJSON) {
    ...
    dataJSON.forEach(library => {
        ...
        // Add release tag to metadata if not yet defined
        ...
        ATTRIBUTES.forEach(attribute => {
            ...
            if (reportAttr) {
                addAttributeMapToLibrary(library, attribute, reportAttr)
            }
...
function addAttributeMapToLibrary(library, attribute, reportAttr) {
