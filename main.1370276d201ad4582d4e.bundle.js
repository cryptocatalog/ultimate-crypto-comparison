...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__searchbar_comparison_searchbar_component__ = __webpack_require__("./src/app/components/comparison/searchbar/comparison.searchbar.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__comparison_component__ = __webpack_require__("./src/app/components/comparison/comparison.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pipes_pipes_module__ = __webpack_require__("./src/app/components/pipes/pipes.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__input_input_module__ = __webpack_require__("./src/app/components/input/input.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__output_output_module__ = __webpack_require__("./src/app/components/output/output.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__configuration_configuration_service__ = __webpack_require__("./src/app/components/comparison/configuration/configuration.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__data_data_service__ = __webpack_require__("./src/app/components/comparison/data/data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__settings_comparison_settings_component__ = __webpack_require__("./src/app/components/comparison/settings/comparison.settings.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ComparisonModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__input_input_module__["a" /* InputModule */],
            __WEBPACK_IMPORTED_MODULE_8__output_output_module__["a" /* OutputModule */],
            __WEBPACK_IMPORTED_MODULE_6__pipes_pipes_module__["a" /* PipesModule */]
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_5__comparison_component__["a" /* ComparisonComponent */]
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_5__comparison_component__["a" /* ComparisonComponent */],
            __WEBPACK_IMPORTED_MODULE_3__details_comparison_details_component__["a" /* ComparisonDetailsComponent */],
            __WEBPACK_IMPORTED_MODULE_4__searchbar_comparison_searchbar_component__["a" /* ComparisonSearchbarComponent */],
            __WEBPACK_IMPORTED_MODULE_11__settings_comparison_settings_component__["a" /* ComparisonSettingsComponent */]
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_9__configuration_configuration_service__["a" /* ConfigurationService */],
...
class Criteria {
    constructor(builder) {
        ...
        this.textSearch = Object(__WEBPACK_IMPORTED_MODULE_0_util__["isNullOrUndefined"])(builder.textSearch) ? false : builder.textSearch;
        ...
        dataService.http.get('data.json')
            ...
            dataArrayObject.forEach(dataObject => {
                ...
                configuration.criteria.forEach((criteriaConfiguration, criteriaKey) => {
                    ...
                    if (criteriaKey === "id") {
                        const type = criteriaConfiguration ? criteriaConfiguration.type : __WEBPACK_IMPORTED_MODULE_4__configuration_configuration__["e" /* CriteriaType */].url;
                        switch (type) {
...
/***/ "./src/app/components/comparison/searchbar/comparison.searchbar.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "input.searchbar {\n    width: 100%;\n    border: 0 !important;\n    border-bottom: 1px solid #aaa !important;\n    border-radius: 0 !important;\n    margin-top: 8px;\n}\n\ninput.searchbar:focus {\n    outline-width: 0;\n}\n", ""]);
...
/***/ "./src/app/components/comparison/searchbar/comparison.searchbar.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ComparisonSearchbarComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
let ComparisonSearchbarComponent = ComparisonSearchbarComponent_1 = class ComparisonSearchbarComponent {
    constructor() {
        this.value = '';
        this.result = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        ComparisonSearchbarComponent_1.components.push(this);
    }
    valueChanged() {
        this.result.emit(this.content.nativeElement.value);
    }
    getValue() {
        if (Object(__WEBPACK_IMPORTED_MODULE_1_util__["isNullOrUndefined"])(this.value)) {
            return '';
        }
        return this.value;
    }
};
ComparisonSearchbarComponent.components = [];
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], ComparisonSearchbarComponent.prototype, "value", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('textvalue'),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"])
], ComparisonSearchbarComponent.prototype, "content", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"])
], ComparisonSearchbarComponent.prototype, "result", void 0);
ComparisonSearchbarComponent = ComparisonSearchbarComponent_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'comparison-searchbar',
        template: __webpack_require__("./src/app/components/comparison/searchbar/comparison.searchbar.template.html"),
        styles: [__webpack_require__("./src/app/components/comparison/searchbar/comparison.searchbar.component.css")]
    }),
    __metadata("design:paramtypes", [])
], ComparisonSearchbarComponent);

var ComparisonSearchbarComponent_1;


/***/ }),

/***/ "./src/app/components/comparison/searchbar/comparison.searchbar.template.html":
/***/ (function(module, exports) {

module.exports = "<input class=\"searchbar\" #textvalue\n       type=\"text\" placeholder=\"Search...\"\n       (keyup.enter)=\"valueChanged($event)\"\n       [value]=\"getValue()\">\n"
    ...
    __WEBPACK_IMPORTED_MODULE_1__components_comparison_data_data_service__["a" /* DataService */].data.forEach((value, i) => {
        ...
        for (const field of state.currentSearch.keys()) {
            ...
            if (criteria.textSearch) {
                ...
                let fulfillsField = criteria.andSearch || Object(__WEBPACK_IMPORTED_MODULE_3_util__["isNullOrUndefined"])(searchArray) || searchArray.length === 0;
                for (const query of searchArray) {
                    if (query === '') {
                        continue;
                    }
                    const queryLower = query.toLocaleLowerCase();
                    const val = data[i].criteria.get(criteria.key).text
                        || data[i].criteria.get(criteria.key).content
                        || data[i].criteria.get(criteria.key).content;
                ...
                if (state.currentSearch.get(field).length > 0) {
                    ...
                    for (const query of queries) {
                        ...
                        const labelMap = value.criteria.get(field);
                ...
                for (const query of searchArray) {
                    ...
                    for (const key of data[i].criteria.get(criteria.key).keys()) {
...
class VersionInformation {
    constructor() {
        this.tag = "v2.0.0-alpha.19";
        this.tagDate = "2018-03-12";
        this.tagLink = "https://github.com/ultimate-comparisons/ultimate-comparison-BASE/tree/v2.0.0-alpha.19";
    }
}
...
//# sourceMappingURL=main.1370276d201ad4582d4e.bundle.js.map